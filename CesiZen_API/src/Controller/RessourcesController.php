...
class RessourcesController
{
    ...
    #[Route('/api/ressources', name: 'api_ressources_list_custom', methods: ['GET'])]
    public function list(): JsonResponse
    {
        $ressources = $this->ressourcesRepository->findAll();

        $data = array_map(
            fn (RESSOURCES $ressource) => $this->formatRessource($ressource),
            $ressources
        );
    ...
    #[Route('/api/ressources/{id}', name: 'api_ressource_by_id_custom', methods: ['GET'])]
    public function detailById(int $id): JsonResponse
    {
    ...
    #[Route('/api/ressource/{slug}', name: 'api_ressource_by_slug_custom', methods: ['GET'])]
    public function detailBySlug(string $slug): JsonResponse
    {
