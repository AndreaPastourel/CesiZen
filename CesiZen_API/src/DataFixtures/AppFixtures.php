...
$emotionsData = [
    'Joie' => [
        [
            'nom' => 'Contentement',
            'icone' => '/uploads/emotions/contentement.png',
            'couleur' => '#A8C98F',
            'intensite_min' => 1,
            'intensite_max' => 2,
        ],
        [
            'nom' => 'Gratitude',
            'icone' => '/uploads/emotions/gratitude.png',
            'couleur' => '#95BE7D',
            'intensite_min' => 2,
            'intensite_max' => 3,
        ],
        [
            'nom' => 'Fierté',
            'icone' => '/uploads/emotions/fierte.png',
            'couleur' => '#7FA36B',
            'intensite_min' => 3,
            'intensite_max' => 5,
        ],
        [
            'nom' => 'Enchantement',
            'icone' => '/uploads/emotions/enchantement.png',
            'couleur' => '#6F985D',
            'intensite_min' => 5,
            'intensite_max' => 7,
        ],
        [
            'nom' => 'Excitation',
            'icone' => '/uploads/emotions/excitation.png',
            'couleur' => '#5E8B50',
            'intensite_min' => 7,
            'intensite_max' => 9,
        ],
        [
            'nom' => 'Émerveillement',
            'icone' => '/uploads/emotions/emerveillement.png',
            'couleur' => '#4D7D43',
            'intensite_min' => 9,
            'intensite_max' => 10,
        ],
    ...
    'Colère' => [
        [
            'nom' => 'Agacement',
            'icone' => '/uploads/emotions/agacement.png',
            'couleur' => '#E8A09A',
            'intensite_min' => 1,
            'intensite_max' => 2,
        ],
        [
            'nom' => 'Irritation',
            'icone' => '/uploads/emotions/irritation.png',
            'couleur' => '#DD8780',
            'intensite_min' => 2,
            'intensite_max' => 4,
        ],
        [
            'nom' => 'Frustration',
            'icone' => '/uploads/emotions/frustration.png',
            'couleur' => '#D5736C',
            'intensite_min' => 4,
            'intensite_max' => 6,
        ],
        [
            'nom' => 'Ressentiment',
            'icone' => '/uploads/emotions/ressentiment.png',
            'couleur' => '#C96B6B',
            'intensite_min' => 6,
            'intensite_max' => 8,
        ],
        [
            'nom' => 'Hostilité',
            'icone' => '/uploads/emotions/hostilite.png',
            'couleur' => '#B95858',
            'intensite_min' => 8,
            'intensite_max' => 9,
        ],
        [
            'nom' => 'Rage',
            'icone' => '/uploads/emotions/rage.png',
            'couleur' => '#A94444',
            'intensite_min' => 9,
            'intensite_max' => 10,
        ],
    ...
    'Peur' => [
        [
            'nom' => 'Crainte',
            'icone' => '/uploads/emotions/crainte.png',
            'couleur' => '#A8BED0',
            'intensite_min' => 1,
            'intensite_max' => 2,
        ],
        [
            'nom' => 'Inquiétude',
            'icone' => '/uploads/emotions/inquietude.png',
            'couleur' => '#91AEC3',
            'intensite_min' => 2,
            'intensite_max' => 4,
        ],
        [
            'nom' => 'Appréhension',
            'icone' => '/uploads/emotions/apprehension.png',
            'couleur' => '#7D9DB6',
            'intensite_min' => 4,
            'intensite_max' => 6,
        ],
        [
            'nom' => 'Anxiété',
            'icone' => '/uploads/emotions/anxiete.png',
            'couleur' => '#6B8FA3',
            'intensite_min' => 6,
            'intensite_max' => 8,
        ],
        [
            'nom' => 'Panique',
            'icone' => '/uploads/emotions/panique.png',
            'couleur' => '#5A7C91',
            'intensite_min' => 8,
            'intensite_max' => 9,
        ],
        [
            'nom' => 'Terreur',
            'icone' => '/uploads/emotions/terreur.png',
            'couleur' => '#49697E',
            'intensite_min' => 9,
            'intensite_max' => 10,
        ],
    ...
    'Tristesse' => [
        [
            'nom' => 'Mélancolie',
            'icone' => '/uploads/emotions/melancolie.png',
            'couleur' => '#C7B7A4',
            'intensite_min' => 1,
            'intensite_max' => 2,
        ],
        [
            'nom' => 'Solitude',
            'icone' => '/uploads/emotions/solitude.png',
            'couleur' => '#B9A58F',
            'intensite_min' => 2,
            'intensite_max' => 4,
        ],
        [
            'nom' => 'Chagrin',
            'icone' => '/uploads/emotions/chagrin.png',
            'couleur' => '#AB947B',
            'intensite_min' => 4,
            'intensite_max' => 6,
        ],
        [
            'nom' => 'Abattement',
            'icone' => '/uploads/emotions/abattement.png',
            'couleur' => '#A3846B',
            'intensite_min' => 6,
            'intensite_max' => 8,
        ],
        [
            'nom' => 'Désespoir',
            'icone' => '/uploads/emotions/desespoir.png',
            'couleur' => '#8E715A',
            'intensite_min' => 8,
            'intensite_max' => 9,
        ],
        [
            'nom' => 'Dépression',
            'icone' => '/uploads/emotions/depression.png',
            'couleur' => '#765D49',
            'intensite_min' => 9,
            'intensite_max' => 10,
        ],
    ...
    'Surprise' => [
        [
            'nom' => 'Étonnement',
            'icone' => '/uploads/emotions/etonnement.png',
            'couleur' => '#E8D58F',
            'intensite_min' => 1,
            'intensite_max' => 2,
        ],
        [
            'nom' => 'Incrédule',
            'icone' => '/uploads/emotions/incredule.png',
            'couleur' => '#DFC875',
            'intensite_min' => 2,
            'intensite_max' => 4,
        ],
        [
            'nom' => 'Confusion',
            'icone' => '/uploads/emotions/confusion.png',
            'couleur' => '#D8BD63',
            'intensite_min' => 4,
            'intensite_max' => 6,
        ],
        [
            'nom' => 'Stupéfaction',
            'icone' => '/uploads/emotions/stupefaction.png',
            'couleur' => '#D4B052',
            'intensite_min' => 6,
            'intensite_max' => 8,
        ],
        [
            'nom' => 'Sidération',
            'icone' => '/uploads/emotions/sideration.png',
            'couleur' => '#BE9C46',
            'intensite_min' => 8,
            'intensite_max' => 9,
        ],
        [
            'nom' => 'Émerveillement surpris',
            'icone' => '/uploads/emotions/emerveillement-surpris.png',
            'couleur' => '#AA893B',
            'intensite_min' => 9,
            'intensite_max' => 10,
        ],
    ...
    'Dégoût' => [
        [
            'nom' => 'Déplaisir',
            'icone' => '/uploads/emotions/deplaisir.png',
            'couleur' => '#C5A9C9',
            'intensite_min' => 1,
            'intensite_max' => 2,
        ],
        [
            'nom' => 'Dédain',
            'icone' => '/uploads/emotions/dedain.png',
            'couleur' => '#B795BD',
            'intensite_min' => 2,
            'intensite_max' => 4,
        ],
        [
            'nom' => 'Nausée',
            'icone' => '/uploads/emotions/nausee.png',
            'couleur' => '#AA85B1',
            'intensite_min' => 4,
            'intensite_max' => 6,
        ],
        [
            'nom' => 'Répulsion',
            'icone' => '/uploads/emotions/repulsion.png',
            'couleur' => '#9A7FA3',
            'intensite_min' => 6,
            'intensite_max' => 8,
        ],
        [
            'nom' => 'Horreur',
            'icone' => '/uploads/emotions/horreur.png',
            'couleur' => '#84668C',
            'intensite_min' => 8,
            'intensite_max' => 9,
        ],
        [
            'nom' => 'Dégoût profond',
            'icone' => '/uploads/emotions/degout-profond.png',
            'couleur' => '#6E5076',
            'intensite_min' => 9,
            'intensite_max' => 10,
        ],
...
foreach ($emotionsData as $typeEmotionNom => $emotionsDuType) {
    foreach ($emotionsDuType as $emotionData) {
        ...
        $emotion->setCouleur($emotionData['couleur']);
