...
export default function ProfilInfoFormFields({prenom,nom,pseudo,email,telephone,photo_profil,setPrenom,setNom,setPseudo,setEmail,setTelephone,photoPreview,handlePhotoChange,photoFile}:Readonly<Props>){
